...
const Login = () => {
  ...
  const CompanyLogo = ({ company, className = "h-12 w-12" }) => {
    ...
    useEffect(() => {
      ...
      if (company.logoUrl) {
        if (company.logoUrl.includes("logo.clearbit.com")) {
          const domain = company.logoUrl.replace(
    ...
    const handleError = () => {
      if (fallbackLevel === 0) {
        ...
        if (imgSrc && imgSrc.includes("logos.hunter.io/")) {
          ...
          company.logoUrl &&
          company.logoUrl.includes("logo.clearbit.com")
        ) {
    ...
    if (fallbackLevel >= 2 || !imgSrc) {
      return (
        <div
          className={`${className} shrink-0 rounded-xl ${colorClass} flex items-center justify-center font-black text-xl select-none border border-slate-200/50 dark:border-slate-800`}
        >
  ...
  const handleOpenPreview = async (key) => {
    ...
    if (key === "linkedin") {
      setPreviewData([
        {
          id: 1,
          name: "Profile Headline Scanner",
          description:
            "Verifies the presence of key industry keywords and role clarity.",
        },
        {
          id: 2,
          name: "Summary & About Evaluator",
          description:
            "Checks for narrative engagement, contact callouts, and skill density.",
        },
        {
          id: 3,
          name: "Work History Analyzer",
          description:
            "Validates action-verb usage, accomplishment metrics, and timeline continuity.",
        },
        {
          id: 4,
          name: "Skills Matcher",
          description:
            "Compares listed technical skills against standard industry profiles.",
        },
      ]);
    ...
    if (key === "resume") {
      setPreviewData([
        {
          id: 1,
          name: "Single-Column Layout Format",
          description:
            "Ensures layout parses cleanly in all major ATS parsers.",
        },
        {
          id: 2,
          name: "Section Headers Standardization",
          description:
            "Validates headers match industry standards (Experience, Education, Skills).",
        },
        {
          id: 3,
          name: "Keyword Density Scanning",
          description:
            "Matches resume descriptions with target job description terms.",
        },
        {
          id: 4,
          name: "Action Verb Frequency",
          description:
            "Evaluates bullet point strength based on performance action verbs.",
        },
      ]);
      setPreviewLoading(false);
      return;
        ...
        <div className="hidden lg:flex w-1/2 flex-col justify-between p-16 relative z-10">
          ...
          >
            ...
            <div>
              ...
              <span className="block text-[10px] font-bold text-sky-500 dark:text-sky-400 uppercase tracking-widest">
                Career Platform
              </span>
            </div>
          </motion.div>
          ...
          >
            ...
            <p className="text-slate-650 dark:text-slate-400 text-lg leading-relaxed max-w-md font-medium">
              Structured courses, AI mock interviews, real coding challenges,
              and company-specific preparation — all in one platform.
            </p>
          ...
          >
            ...
            <div className="bg-white/80 dark:bg-slate-900/80 backdrop-blur-2xl border border-slate-200 dark:border-slate-700/50 rounded-3xl p-8 shadow-xl dark:shadow-2xl shadow-slate-200/50 dark:shadow-black/40">
              ...
              <div className="lg:hidden flex items-center gap-2 mb-6">
                <div className="h-9 w-9 rounded-xl bg-gradient-to-tr from-sky-500 to-indigo-600 flex items-center justify-center text-white font-black shadow-lg">
                  CF
                </div>
              ...
              <div className="mb-8">
                ...
                <p className="text-slate-650 dark:text-slate-400 text-sm mt-1.5 font-medium">
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                ...
                <div>
                  ...
                  <div
                    className={`relative transition-all duration-200 ${focused === "user" ? "ring-2 ring-sky-500/30 rounded-xl" : ""}`}
                  >
                    <span
                      className={`absolute inset-y-0 left-0 pl-3.5 flex items-center transition-colors ${focused === "user" ? "text-sky-550" : "text-slate-450 dark:text-slate-550"}`}
                    >
                      <Mail size={16} />
                    </span>
                    <input
                ...
                <div>
                  ...
                  <div
                    className={`relative transition-all duration-200 ${focused === "pass" ? "ring-2 ring-sky-500/30 rounded-xl" : ""}`}
                  >
                    <span
                      className={`absolute inset-y-0 left-0 pl-3.5 flex items-center transition-colors ${focused === "pass" ? "text-sky-550" : "text-slate-450 dark:text-slate-550"}`}
                    >
                      <KeyRound size={16} />
                    </span>
                    <input
        ...
        <div className="max-w-6xl mx-auto space-y-16">
          ...
          <div className="text-center space-y-4">
            ...
            <p className="text-slate-650 dark:text-slate-400 max-w-2xl mx-auto text-sm md:text-base font-semibold leading-relaxed">
              Discover the cutting-edge modules and tools that make CareerForge
              the ultimate learning and interview preparation hub.
            </p>
          </div>
          ...
          <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
            ...
            >
              <div>
                ...
                <h3 className="text-slate-900 dark:text-white text-lg font-extrabold flex items-center justify-between">
                  Coding Arena
                  <span className="text-[10px] text-primary-600 dark:text-primary-400 font-bold opacity-0 group-hover:opacity-100 transition-opacity">
                    Preview &rarr;
                  </span>
                </h3>
                <p className="text-slate-600 dark:text-slate-300 text-xs leading-relaxed font-semibold mt-2.5">
                  Solve 100+ industry-standard DSA challenges. Write, compile,
                  and run code in our local sandboxed execution engine
                  supporting Python, Java, and JavaScript.
                </p>
              </div>
            </div>
            ...
            >
              <div>
                ...
                <h3 className="text-slate-900 dark:text-white text-lg font-extrabold flex items-center justify-between">
                  AI Interview Suite
                  <span className="text-[10px] text-sky-650 dark:text-sky-400 font-bold opacity-0 group-hover:opacity-100 transition-opacity">
                    Preview &rarr;
                  </span>
                </h3>
                <p className="text-slate-600 dark:text-slate-300 text-xs leading-relaxed font-semibold mt-2.5">
                  Practice customized mock interviews matching specific roles
                  and technologies. Get real-time AI analytics, performance
            ...
            >
              <div>
                ...
                <h3 className="text-slate-900 dark:text-white text-lg font-extrabold flex items-center justify-between">
                  Learning Center
                  <span className="text-[10px] text-emerald-600 dark:text-emerald-400 font-bold opacity-0 group-hover:opacity-100 transition-opacity">
                    Preview &rarr;
                  </span>
                </h3>
                <p className="text-slate-600 dark:text-slate-300 text-xs leading-relaxed font-semibold mt-2.5">
                  Gain complete domain mastery with 111+ structured pathways.
                  Study detailed notes, watch video guides, and access
            ...
            >
              <div>
                ...
                <h3 className="text-slate-900 dark:text-white text-lg font-extrabold flex items-center justify-between">
                  Hiring Intelligence
                  <span className="text-[10px] text-amber-655 dark:text-amber-400 font-bold opacity-0 group-hover:opacity-100 transition-opacity">
                    Preview &rarr;
                  </span>
                </h3>
                <p className="text-slate-600 dark:text-slate-305 text-xs leading-relaxed font-semibold mt-2.5">
                  Study comprehensive guides for 30+ top tech companies. Review
                  recruitment pipelines, required stacks, eligibility criteria,
            ...
            >
              <div>
                ...
                <p className="text-slate-600 dark:text-slate-300 text-xs leading-relaxed font-semibold mt-2.5">
                  Analyze your professional presence and get intelligence
                  reports to optimize your profile for technical recruiters.
                </p>
              </div>
            </div>
            ...
            >
              <div>
                ...
                <h3 className="text-slate-900 dark:text-white text-lg font-extrabold flex items-center justify-between">
                  Resume Builder
                  <span className="text-[10px] text-teal-600 dark:text-teal-400 font-bold opacity-0 group-hover:opacity-100 transition-opacity">
                    Preview &rarr;
                  </span>
                </h3>
                <p className="text-slate-600 dark:text-slate-300 text-xs leading-relaxed font-semibold mt-2.5">
                  Build clean, ATS-compliant resumes with integrated format
                  checks and optimization checklists. Download print-ready PDFs
                  instantly.
                </p>
              </div>
            </div>
              ...
              >
                  ...
                  {previewLoading ? (
                    <div className="py-20 flex flex-col items-center justify-center gap-3">
                      ...
                      <span className="text-slate-500 dark:text-slate-400 text-xs font-semibold">
                        Fetching related database content...
                      </span>
                    </div>
                  ) : (
                    <div className="space-y-4">
                      <p className="text-slate-650 dark:text-slate-300 text-sm font-semibold mb-4">
                        Explore premium preview metrics and items directly from
                        our placement preparation engine:
                      </p>
                          ...
                          previewData.map((item, index) => {
                            if (previewKey === "coding") {
                              return (
                                <div
                                  key={item.id || index}
                                  className="p-5 bg-slate-100/50 dark:bg-slate-950/60 border border-slate-200 dark:border-slate-800 rounded-2xl flex flex-col justify-between gap-3 hover:border-primary-500/40 hover:bg-slate-200/60 dark:hover:bg-slate-900/60 transition-all group relative overflow-hidden"
                                >
                            ...
                            if (previewKey === "learning") {
                              return (
                                <div
                                  key={item.id || index}
                                  className="p-5 bg-slate-100/50 dark:bg-slate-950/60 border border-slate-200 dark:border-slate-800 rounded-2xl flex flex-col justify-between gap-3 hover:border-emerald-500/40 hover:bg-slate-200/60 dark:hover:bg-slate-900/60 transition-all group relative overflow-hidden"
                                >
                            ...
                            if (previewKey === "interview") {
                              return (
                                <div
                                  key={item.id || index}
                                  className="p-5 bg-slate-100/50 dark:bg-slate-950/60 border border-slate-200 dark:border-slate-800 rounded-2xl flex flex-col justify-between gap-3 hover:border-sky-500/40 hover:bg-slate-200/60 dark:hover:bg-slate-900/60 transition-all group relative overflow-hidden"
                                >
                ...
                <div className="border-t border-slate-200 dark:border-slate-800 pt-6 mt-8 flex flex-col sm:flex-row items-center justify-between gap-4">
                  <p className="text-[11px] text-slate-655 dark:text-slate-400 font-semibold text-center sm:text-left">
                    Want to access the full workspace, interactive compiler
                    tests, and personalized tracker metrics?
                  </p>
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-slate-350 font-extrabold">
                      {selectedCompany.hiringRoles} •{" "}
                      {selectedCompany.salaryPackage
                        ?.toLowerCase()
                        .includes("lpa")
                        ? selectedCompany.salaryPackage
                        : `${selectedCompany.salaryPackage} LPA`}
                    </p>
                  </div>
                </div>
                <button
                      ...
                      <div className="space-y-6">
                        ...
                        <div className="p-5 bg-slate-100/50 dark:bg-slate-955/60 border border-slate-200 dark:border-slate-800/80 rounded-2xl space-y-2">
                          ...
                          <p className="text-xs text-slate-655 dark:text-slate-300 leading-relaxed font-bold">
                            {selectedCompany.companyDescription ||
                              "Leading technology recruiter offering placement opportunities for core platform engineering roles."}
                          </p>
                        </div>
                        ...
                        <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 bg-slate-100/50 dark:bg-slate-950/40 p-4 rounded-2xl border border-slate-200 dark:border-slate-800/80">
                          <div>
                            ...
                            <span className="text-sm font-black text-slate-850 dark:text-white mt-0.5">
                              {selectedCompany.foundedYear || "1998"}
                            </span>
                          </div>
                          <div>
                            <span className="text-[10px] text-slate-500 dark:text-slate-400 font-bold block uppercase tracking-wider">
                            ...
                            <span className="text-sm font-black text-slate-850 dark:text-white mt-0.5">
                              {selectedCompany.headquarters || "USA"}
                            </span>
                          </div>
                          <div>
                            <span className="text-[10px] text-slate-500 dark:text-slate-400 font-bold block uppercase tracking-wider">
                            ...
                            <span className="text-sm font-black text-slate-850 dark:text-white mt-0.5">
                              {selectedCompany.employeeCount || "10,000+"}
                            </span>
                          </div>
                          <div>
                            <span className="text-[10px] text-slate-500 dark:text-slate-400 font-bold block uppercase tracking-wider">
                              ...
                              <div className="flex flex-wrap gap-2">
                                {selectedCompany.requiredSkills
                                  ...
                                  .map((skill, i) => (
                                    <span
                                      key={i}
                                      className="bg-primary-500/10 text-primary-650 dark:text-primary-400 text-xs font-black px-3.5 py-1.5 rounded-xl border border-primary-500/10 hover:border-primary-500/30 transition-all"
                                    >
                                      {skill.trim()}
                                    </span>
                                  ))}
                          ...
                          <div className="space-y-6">
                                  ...
                                  return (
                                    <div key={i} className="relative group">
                                      ...
                                      <div className="p-3.5 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-xl hover:border-primary-500/30 transition-all shadow-sm">
                                        <span className="text-xs font-extrabold text-slate-700 dark:text-slate-200 leading-relaxed block">
                                          {cleanRound}
                                        </span>
                                      </div>
                                    </div>
                            ...
                            <div className="bg-sky-500/5 dark:bg-sky-500/10 rounded-2xl p-5 border border-sky-500/20 space-y-2">
                              <h4 className="text-xs font-black text-sky-600 dark:text-sky-400 flex items-center gap-1.5">
                                <TrendingUp size={14} /> AI Hiring Trend
                                Insights
                              </h4>
                              <p className="text-xs text-slate-655 dark:text-slate-300 leading-relaxed font-semibold">
                                {selectedCompany.hiringTrends ||
                                  "This company has increased hiring for full stack systems. Technical questions heavily focus on logical operations, database indexes, and OOP principles."}
                              </p>
                            </div>
                          </div>
                        </div>
                    ...
                    {[
                      {
                        ...
                        type: "Full-Time",
                        code: "SWE-892",
                        loc: selectedCompany.jobLocation.split(",")[0],
                        applicants: Math.floor(
                          selectedCompany.totalApplicants * 0.45,
                        ),
                        desc: "Develop and maintain core platform infrastructure. Design high-performance distributed REST APIs, and collaborate closely with product teams to build clean developer tools.",
                      },
                      {
                        title: "Associate Engineer - Cloud Native Solutions",
                        type: "Full-Time",
                        code: "ASE-302",
                        loc: "Remote / Office Hybrid",
                        applicants: Math.floor(
                          selectedCompany.totalApplicants * 0.35,
                        ),
                        desc: "Architect solutions utilizing AWS/Azure services. Focus on building and managing scalable Docker and Kubernetes environments for microservice deployments.",
                      },
                      {
                        title: "Systems Quality Assurance Engineer",
                        type: "Full-Time",
                        code: "SQA-119",
                        loc: selectedCompany.jobLocation.split(",")[0],
                        applicants: Math.floor(
                          selectedCompany.totalApplicants * 0.2,
                        ),
                        desc: "Build automated testing frameworks for multi-platform applications. Ensure robust integration, regression, and unit test execution for enterprise software suites.",
                      },
                    ]
                      .slice(0, Math.min(3, selectedCompany.jobPostsCount || 3))
                      .map((job, idx) => (
                        <div
                          key={job.code}
                          className="bg-slate-100/50 dark:bg-slate-955/60 rounded-2xl p-5 border border-slate-200 dark:border-slate-800 space-y-3"
                        >
                          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2">
                            <div>
                              <h4 className="text-sm font-black text-slate-905 dark:text-white">
                                {job.title}
                              </h4>
                              <span className="text-[10px] text-slate-500 dark:text-slate-400 font-bold block mt-0.5">
                                Code: {job.code} • {job.loc} • {job.type}
                              </span>
                            </div>
                          ...
                          <div className="flex flex-wrap gap-1.5 pt-1">
                            {selectedCompany.requiredSkills
                              ...
                              .map((skill, i) => (
                                <span
                                  key={i}
                                  className="bg-slate-200 dark:bg-slate-800 text-[10px] font-black px-2.5 py-0.5 rounded text-slate-700 dark:text-slate-300"
                                >
                                  {skill.trim()}
                                </span>
                              ))}
                  ...
                  <div className="space-y-4">
                    {prepLoading ? (
                      ...
                      <div className="text-center py-12 bg-slate-100/50 dark:bg-slate-950/60 rounded-2xl border border-slate-200 dark:border-slate-800">
                        <BookOpen
                          size={36}
                          className="mx-auto text-slate-500 dark:text-slate-600 mb-3"
                        />
                        <h4 className="font-extrabold text-sm text-slate-600 dark:text-slate-350">
                          No official prep questions configured yet
                        </h4>
                        <p className="text-[10px] text-slate-500 dark:text-slate-500 mt-0.5">
                          We will launch simulated practice patterns shortly.
                        </p>
                      </div>
                    ) : (
                      prepQuestions.map((q) => (
                        <div
                          key={q.id}
                          className="bg-slate-100/50 dark:bg-slate-955/60 rounded-2xl p-5 border border-slate-200 dark:border-slate-800 space-y-2.5"
                        >
                          <div className="flex items-center justify-between">
                            <span
                              className={`text-[9px] font-extrabold px-2.5 py-0.5 rounded-full ${q.difficulty === "HARD" ? "bg-rose-500/10 text-rose-600 dark:text-rose-500" : q.difficulty === "MEDIUM" ? "bg-amber-500/10 text-amber-600 dark:text-amber-500" : "bg-emerald-500/10 text-emerald-600 dark:text-emerald-500"}`}
                            >
                              {q.difficulty}
                            </span>
                          ...
                          <h4 className="text-xs font-black text-slate-900 dark:text-white flex gap-1.5">
                            <span className="text-primary-500 font-black shrink-0">
                              Q:
                            </span>
                          ...
                          <div className="text-xs text-slate-655 dark:text-slate-300 leading-relaxed pt-2.5 border-t border-slate-200 dark:border-slate-800 flex gap-1.5 font-semibold">
                            ...
                            <div>
                              <span className="font-black text-slate-850 dark:text-white block mb-1">
                                Answer Strategy:
                              </span>
                              {q.answer}
                            </div>
